...
tyrano.plugin.kag.tag.movie = {
  ...
  start: function (pm) {
    if ("pc" != $.userenv()) {
      ...
      ("firefox" != $.getBrowser() && "opera" != $.getBrowser()) ||
      ...
      if (
        ...
        for (key in chara_layer) {
          ...
          "none" == chara_obj.storage
            ? (part_storage = "./tyrano/images/system/white.png")
          ...
          if ("" != pm.time) {
            ...
            for (key in map_part)
              !(function () {
                ...
                "none" != part.storage
                  ...
                  : j_new_img.attr("src", "./tyrano/images/system/white.png");
                pm[key + "_zindex"]
            ...
            for (key in map_part) {
              ...
              "none" != part.storage
                ...
                : j_img.attr("src", "./tyrano/images/system/white.png");
              pm[key + "_zindex"]
