tyrano.plugin.kag.studio = {
  ...
  init: function () {
    if (-1 != window.navigator.userAgent.indexOf("TyranoStudio")) {
      ...
      var j_reload_button = $(
        "<div style='position:absolute;z-index:999999999;padding:10px;opacity:0.8;background-color:white;left:0px;top:0px'><button style='cursor:pointer'><span style=''>リロード</span></button></div>"
      );
