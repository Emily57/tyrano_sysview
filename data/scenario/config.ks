...
; 	tf.btn_path_on  = tf.img_path + 'c_set';
...
; 	[bg storage="&tf.img_path +'bg_config'" time="100"]

; ;	画面右上の「Back」ボタン
; 	[button fix="true" graphic="&tf.img_path + 'c_btn_back'" enterimg="&tf.img_path + 'c_btn_back2'" target="*backtitle" x="1160" y="20"]
...
; 	$(".bgmvol_"+tf.current_bgm_vol).attr("src","data/image/config/c_set");

; 	$(".sevol_"+tf.current_se_vol).attr("src","data/image/config/c_set");

; 	$(".ch_"+tf.current_ch_speed).attr("src","data/image/config/c_set");

; 	$(".auto_"+tf.current_auto_speed).attr("src","data/image/config/c_set");

; 	if(tf.text_skip == 'OFF'){
; 		$(".unread_off").attr("src","./data/image/config/c_skipoff");
; 		}else{
; 			$(".unread_on").attr("src","./data/image/config/c_skipon");
; 			}
; 	[endscript]
...
; [iscript]
; 	$(".bgmvol").attr("src","data/image/config/c_btn");
; 	$(".bgmvol_"+tf.current_bgm_vol).attr("src","data/image/config/c_set");
; [endscript]
...
; [iscript]
; 	$(".sevol").attr("src","data/image/config/c_btn");
; 	$(".sevol_"+tf.current_se_vol).attr("src","data/image/config/c_set");
; [endscript]
...
; 	$(".ch").attr("src","data/image/config/c_btn");
; 	$(".ch_"+tf.set_ch_speed).attr("src","data/image/config/c_set");
...
; 	$(".auto").attr("src","data/image/config/c_btn");
; 	$(".auto_"+tf.set_auto_speed).attr("src","data/image/config/c_set");
...
; ;	BGM
; 	[image layer="0" name="bgm_img_0"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[0]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_1"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[1]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_2"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[2]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_3"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[3]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_4"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[4]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_5"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[5]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_6"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[6]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_7"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[7]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_8"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[8]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_9"  storage="&tf.img_path + 'set1'"  x="&tf.config_x[9]"  y="&tf.config_y_bgm"]
; 	[image layer="0" name="bgm_img_10" storage="&tf.img_path + 'set1'"  x="&tf.config_x[10]" y="&tf.config_y_bgm"]

; ;	SE
; 	[image layer="0" name="se_img_0"  storage="&tf.img_path + 'set2'" x="&tf.config_x[0]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_1"  storage="&tf.img_path + 'set2'" x="&tf.config_x[1]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_2"  storage="&tf.img_path + 'set2'" x="&tf.config_x[2]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_3"  storage="&tf.img_path + 'set2'" x="&tf.config_x[3]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_4"  storage="&tf.img_path + 'set2'" x="&tf.config_x[4]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_5"  storage="&tf.img_path + 'set2'" x="&tf.config_x[5]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_6"  storage="&tf.img_path + 'set2'" x="&tf.config_x[6]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_7"  storage="&tf.img_path + 'set2'" x="&tf.config_x[7]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_8"  storage="&tf.img_path + 'set2'" x="&tf.config_x[8]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_9"  storage="&tf.img_path + 'set2'" x="&tf.config_x[9]"  y="&tf.config_y_se"]
; 	[image layer="0" name="se_img_10" storage="&tf.img_path + 'set2'" x="&tf.config_x[10]" y="&tf.config_y_se"]

; ;	テキスト速度
; 	[image layer="0" name="ch_img_1"  storage="&tf.img_path + 'set1'" x="&tf.config_x[1]"  y="&tf.config_y_ch"]
; 	[image layer="0" name="ch_img_2"  storage="&tf.img_path + 'set1'" x="&tf.config_x[2]"  y="&tf.config_y_ch"]
; 	[image layer="0" name="ch_img_3"  storage="&tf.img_path + 'set1'" x="&tf.config_x[3]"  y="&tf.config_y_ch"]
; 	[image layer="0" name="ch_img_4"  storage="&tf.img_path + 'set1'" x="&tf.config_x[4]"  y="&tf.config_y_ch"]
; 	[image layer="0" name="ch_img_5"  storage="&tf.img_path + 'set1'" x="&tf.config_x[5]"  y="&tf.config_y_ch"]
; 	[image layer="0" name="ch_img_6"  storage="&tf.img_path + 'set1'" x="&tf.config_x[6]"  y="&tf.config_y_ch"]
; 	[image layer="0" name="ch_img_7"  storage="&tf.img_path + 'set1'" x="&tf.config_x[7]"  y="&tf.config_y_ch"]
; 	[image layer="0" name="ch_img_8"  storage="&tf.img_path + 'set1'" x="&tf.config_x[8]"  y="&tf.config_y_ch"]
; 	[image layer="0" name="ch_img_9"  storage="&tf.img_path + 'set1'" x="&tf.config_x[9]"  y="&tf.config_y_ch"]
; 	[image layer="0" name="ch_img_10" storage="&tf.img_path + 'set1'" x="&tf.config_x[10]" y="&tf.config_y_ch"]

; ;	オート速度
; 	[image layer="0" name="auto_img_1"  storage="&tf.img_path + 'set2'"  x="&tf.config_x[1]"  y="&tf.config_y_auto"]
; 	[image layer="0" name="auto_img_2"  storage="&tf.img_path + 'set2'"  x="&tf.config_x[2]"  y="&tf.config_y_auto"]
; 	[image layer="0" name="auto_img_3"  storage="&tf.img_path + 'set2'"  x="&tf.config_x[3]"  y="&tf.config_y_auto"]
; 	[image layer="0" name="auto_img_4"  storage="&tf.img_path + 'set2'"  x="&tf.config_x[4]"  y="&tf.config_y_auto"]
; 	[image layer="0" name="auto_img_5"  storage="&tf.img_path + 'set2'"  x="&tf.config_x[5]"  y="&tf.config_y_auto"]
; 	[image layer="0" name="auto_img_6"  storage="&tf.img_path + 'set2'"  x="&tf.config_x[6]"  y="&tf.config_y_auto"]
; 	[image layer="0" name="auto_img_7"  storage="&tf.img_path + 'set2'"  x="&tf.config_x[7]"  y="&tf.config_y_auto"]
; 	[image layer="0" name="auto_img_8"  storage="&tf.img_path + 'set2'"  x="&tf.config_x[8]"  y="&tf.config_y_auto"]
; 	[image layer="0" name="auto_img_9"  storage="&tf.img_path + 'set2'"  x="&tf.config_x[9]"  y="&tf.config_y_auto"]
; 	[image layer="0" name="auto_img_10" storage="&tf.img_path + 'set2'"  x="&tf.config_x[10]" y="&tf.config_y_auto"]
